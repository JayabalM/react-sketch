        ...
        _selectTool = (event) => {
                this.setState({
                        ...
                        enableRemoveSelected:
                                event.target.value === Tools.Select,
        ...
        _onBackgroundImageDrop = (accepted /*, rejected*/) => {
                if (accepted && accepted.length > 0) {
                        ...
                        reader.addEventListener(
                                "load",
                                () =>
                                        sketch.setBackgroundFromDataUrl(
                                                reader.result,
                                                {
                                                        stretched: stretched,
