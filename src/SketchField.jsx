...
class SketchField extends PureComponent {
        ...
        addImg = (dataUrl, options = {}) => {
                ...
                fabric.Image.fromURL(dataUrl, (oImg) => {
                        let opts = {
                                left:
                                        Math.random() *
                                        (canvas.getWidth() - oImg.width * 0.5),
                                top:
                                        Math.random() *
                                        (canvas.getHeight() -
                                                oImg.height * 0.5),
        ...
        _resize = (e, canvasWidth = null, canvasHeight = null) => {
                ...
                let wfactor = (
                        (offsetWidth - widthCorrection) /
                        prevWidth
                ).toFixed(2);
                let hfactor = (
                        (clientHeight - heightCorrection) /
                        prevHeight
                ).toFixed(2);
        ...
        componentDidMount = () => {
         ...
         skipTargetFind: true
                ...
                canvas.on("object:added", (e) =>
                        this.callEvent(e, this._onObjectAdded)
                );
                ...
                canvas.on("mouse:down", (e) =>
                        this.callEvent(e, this._onMouseDown)
                );
                canvas.on("mouse:move", (e) =>
                        this.callEvent(e, this._onMouseMove)
                );
                canvas.on("mouse:up", (e) =>
                        this.callEvent(e, this._onMouseUp)
                );
                canvas.on("mouse:out", (e) =>
                        this.callEvent(e, this._onMouseOut)
                );
        ...
        render = () => {
                ...
                return (
                        ...
                        >
                                ...
                                >
                                        Sorry, Canvas HTML5 element is not
